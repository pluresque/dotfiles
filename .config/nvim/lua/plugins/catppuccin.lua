        ...
        highlight_overrides = {
          all = function(colors)
            return {
              ...
              StatuslineModeInsert = { fg = colors.teal, bg = colors.mantle, bold = true },
              StatuslineModeVisual = { fg = colors.lavender, bg = colors.mantle, bold = true },
              StatuslineModeReplace = { fg = colors.flamingo, bg = colors.mantle, bold = true },
              StatusLineModeCommand = { fg = colors.peach, bg = colors.mantle, bold = true },
              StatuslineModeOther = { fg = colors.mauve, bg = colors.mantle, bold = true },
